...
------------ENTER CVV LAYOUT-----------------------------------------------------------------------------------------------------------
            linearLayout
                ...
                , case state ^. _cardMethod of   
                        SavedCard _ -> visibility VISIBLE
                        _ -> visibility GONE
                , background Color.a_FFFFFFFF
                , padding (PaddingHorizontal 30 30)
                , cornerRadius 8.00
                ] <> overrides (S "OverlayView") push state )
                [ textView
                    ([ height $ V 17
                    , width $ V 81
                    , text "enter CVV"
                    , textSize FontSize.a_14
                    , color FontColor.a_FF303748
                    , fontStyle Font.gILROYBOLD
                    , gravity LEFT
                    ] <> overrides (S "HDFCBank") push state )
                ,  textView
                    ([ height $ V 16
                    , width $ V 150
                    , text $ "for " <> getBankName
                    , textSize FontSize.a_14
                    , letterSpacing 0.82
                    , margin (MarginTop 5)
                    , color FontColor.a_FF303748
